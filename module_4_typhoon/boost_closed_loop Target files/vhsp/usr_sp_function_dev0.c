...
double _control_p__out;
double _control_i__out;
double _control_integrator__out;
double _control_sum2__out;
double _control_limit__out;
double _control_range_shifter_gain1__out;
double _control_range_shifter_sum3__out;
...
//@cmp.svar.start
// state variables
double _control_integrator__state;
double _control_integrator__reset_state;//@cmp.svar.end
...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    if ((_control_not__out != 0.0) || (_control_integrator__reset_state != 0)) {
        _control_integrator__state = 0.0;
    }
